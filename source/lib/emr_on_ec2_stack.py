            ...
            steps=[
                CfnCluster.StepConfigProperty(
                    ...
                    hadoop_jar_step=CfnCluster.HadoopJarStepConfigProperty(
                        ...
                        args=["bash", "-c", f"aws s3 sync s3://aws-dataengineering-day.workshop.aws/data/dms_sample/ticket_purchase_hist s3://{dl_bucket}/raw/ticket_purchase_hist && aws s3 sync s3://aws-dataengineering-day.workshop.aws/data/dms_sample s3://{code_bucket}/data && aws s3 cp s3://aws-data-analytics-workshops/shared_datasets/tpcparquet/dl_tpc_customer/part-00000-8a990a41-0c74-4a62-834e-8397f5cdbc4e-c000.snappy.parquet s3://{code_bucket}/data/dl_tpc_customer/"]
                    )
                 )]
        )
